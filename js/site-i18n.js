const SITE_I18N = {
  zh: {
    ...
    'meta.home.description': 'MK Chou 個人網站 — 周明坤。',
    ...
    'home.about.p1': '（範例）大家好，我是周明坤（Chou, Ming-Kun）。這裡先放一段自我介紹的範例文字，之後可以替換成正式內容。',
    'home.about.p2': '（範例）完整作品請見「專案」頁面。',
  ...
  en: {
    ...
    'meta.home.description': '周明坤 — Chou, Ming-Kun.',
    ...
    'home.about.p1': '(Sample) Hi, I\'m Chou, Ming-Kun. This is placeholder self-introduction text — replace it with the real content later.',
    'home.about.p2': '(Sample) Full work lives under Projects.',
