const SITE_I18N = {
  zh: {
    ...
    'home.hero.tagline': '邊緣人工智慧、嵌入式系統與模型–硬體協同設計。',
    ...
    'home.about.p2': '（範例）目前對邊緣 AI、嵌入式系統與軟硬體協同設計很有興趣，完整作品請見「專案」頁面。',
    'home.contact.label': '聯絡',
    'home.contact.title': '聯絡方式',
    'home.contact.lead': '歡迎就研究、邊緣 AI 或合作機會與我聯繫。',
    'home.contact.email': '電子郵件',
    'home.contact.affiliation': '所屬單位',
    'home.contact.affiliation.value': '國立成功大學 跨領域學士學位學程',
    ...
    'projects.p2.title': '音視覺融合與 DST 跌倒偵測',
  ...
  en: {
    ...
    'home.hero.label': 'Edge AI · Embedded · Co-Design',
    'home.hero.title': 'MK Chou',
    'home.hero.tagline': 'Edge AI, embedded systems, and model–hardware co-design.',
    ...
    'home.about.p2': '(Sample) I\'m interested in edge AI, embedded systems, and hardware–software co-design. Full work lives under Projects.',
    'home.contact.label': 'Contact',
    'home.contact.title': 'Get in touch',
    'home.contact.lead': 'Feel free to reach out about research, edge AI, or collaboration.',
    'home.contact.email': 'Email',
    'home.contact.affiliation': 'Affiliation',
    'home.contact.affiliation.value': 'NCKU Cross-College Elite Program',
    ...
    'projects.p2.title': 'Multimodal Fall Detection with DST',
