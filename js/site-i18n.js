const SITE_I18N = {
  zh: {
    ...
    'projects.p1.desc': '2025 創見南方智慧文旅組第一名——完整記錄同理、定義、發想、原型、測試五階段設計思考過程（神農街／海安路）。僅提案簡報，非實際開發。',
  ...
  en: {
    ...
    'projects.p1.desc': '1st place at Visioning the South 2025 — full design-thinking journey (empathize → test) for Shennong / Hai\'an. Proposal slides only; no shipped app.',
