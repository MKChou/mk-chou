const SITE_I18N = {
  zh: {
    ...
    'home.about.p1': '大家好，我是周明坤（Chou, Ming-Kun），就讀國立成功大學不分系。我喜歡動手做東西，課外也跑田徑、吹管樂、參與社團，還試過配音與短片；這個網站是我整理自己的地方。',
    ...
    'home.contact.affiliation': '所屬單位',
    'home.contact.affiliation.value': '國立成功大學 不分系',
    'home.section.label': '精選',
    'home.section.title': '作品',
    'home.section.lead': '部分已整理完成、可線上閱讀的專案與實作。',
    'home.p2.title': '音視覺融合與 DST 跌倒偵測',
    'home.p2.desc': '在 Jetson Nano 2GB 上結合 CNN、LSTM 與 Dempster-Shafer 證據理論的即時音視覺跌倒偵測。',
    'home.p2.link': '查看作品 →',
    ...
    'projects.p1.title': '台南玩勝：Tainan Play 智慧文旅互動 APP',
    'projects.p1.desc': '台南智慧文旅互動 APP — 以遊戲化任務與互動體驗，帶領遊客探索台南文化與景點。',
    'projects.p1.advisor': '周麗芳 教授（成大心理系）',
    'projects.p1.period': '2025.09 — 2025.10',
    'projects.p2.title': '音視覺融合與 DST 的邊緣裝置即時跌倒偵測',
    'projects.p2.desc': '即時音視覺跌倒偵測：在 Jetson Nano 2GB 上以 Dempster-Shafer 證據理論融合 MoveNet + CNN 與 MFCC + LSTM。',
    ...
    'about.label': '關於',
    'about.title': '關於我',
    'about.lead': '(範例生成  待修改)關於周明坤 — 個人簡介、經歷、興趣與作品。',
    'about.intro': '我是周明坤，就讀國立成功大學不分系。從高雄長大，工職背景讓我對「動手做」特別有感覺；上大學後一路在軟體、硬體與設計之間摸索，也參與學生自治、研究助理與圖書館工作。',
    'about.intro.p2': '我對邊緣 AI 與嵌入式系統很有興趣，做過跌倒偵測、行動應用等專題，也想把模型真的部署到 Jetson、FPGA 這類資源有限的平台上。課餘之餘，我跑過 110m 跨欄、在管樂團吹單簧管，也做過台語配音與防災主題的動畫短片——對我來說，這些和寫程式一樣，都是在練習把想法做完。',
    'about.intro.p3': '這裡放的是我願意留下來的經歷與作品。若你想多聊技術、合作，或只是打個招呼，歡迎聯絡我。',
    'about.skills.label': '專長',
    'about.skills.list': '• 嵌入式系統、邊緣推論、FPGA 加速\n• 深度學習模型落地與硬體協同設計\n• 音視覺融合、骨架序列模型、Flutter 行動應用\n• 設計思考',
    'about.education.label': '學歷',
    'about.education.list': '• 國立成功大學 不分系\n• 高雄高工 綜合高中',
    'about.roles.label': '經歷',
    'about.roles.list': '• 全校不分系系學會會長\n• 非屬學院學生代表\n• 臺大研究計畫兼任助理 — 教育部跨域彈性修業試辦計畫\n• 成大圖書館 資訊系統組 助理',
    'about.clubs.label': '曾任社團',
    'about.clubs.list': '• 成大慈幼社\n• 高雄高工管樂社（單簧管）\n• 林邊國小/國中田徑隊（110mH、200m）\n• 高雄市民管樂團（單簧管）\n• 雄工管樂校友團（單簧管）\n• 成大田徑隊（110mH）',
    'about.creative.label': '創作',
  ...
  en: {
    ...
    'home.about.p1': 'Hi, I\'m Chou, Ming-Kun, in the Cross College Elite Program at NCKU. I like building things — and outside class I\'ve run hurdles, played clarinet in wind ensembles, joined clubs, and tried voice-over and short films. This site is where I keep track of myself.',
    ...
    'home.contact.affiliation': 'Affiliation',
    'home.contact.affiliation.value': 'Cross College Elite Program, NCKU',
    'home.section.label': 'Selected',
    'home.section.title': 'Work',
    'home.section.lead': 'Some projects and builds available to read online.',
    'home.p2.title': 'Multimodal Fall Detection with DST',
    'home.p2.desc': 'Real-time audio-visual fall detection fusing CNN, LSTM, and Dempster-Shafer Theory on the Jetson Nano 2GB.',
    ...
    'projects.p1.title': '台南玩勝 — Tainan Play: Smart Cultural Tourism App',
    'projects.p1.desc': 'A smart cultural tourism app for Tainan — gamified quests and interactive experiences for exploring local culture and landmarks.',
    'projects.p1.advisor': 'Prof. Li-Fang Chou (Dept. of Psychology, NCKU)',
    'projects.p1.period': 'Sep 2024 — Dec 2024',
    'projects.p2.title': 'Edge Real-Time Fall Detection with Audio-Visual Fusion and DST',
    'projects.p2.desc': 'Real-time audio-visual fall detection fusing MoveNet + CNN and MFCC + LSTM with Dempster-Shafer Theory on the Jetson Nano 2GB.',
    ...
    'about.intro': 'I\'m Chou, Ming-Kun, studying in the Cross College Elite Program at NCKU. I grew up in Kaohsiung; a vocational high-school background taught me to learn by doing. At university I\'ve moved between software, hardware, and design, while also taking on student leadership, a research assistant role, and library work.',
    'about.intro.p2': 'I\'m especially interested in edge AI and embedded systems — fall detection, mobile apps, and getting models to run on resource-constrained platforms like Jetson and FPGA. Outside class I\'ve run 110m hurdles, played clarinet in concert bands, and worked on Taiwanese voice-over and a disaster-prevention animation short. To me, those are all practice in finishing ideas, same as coding.',
    ...
    'about.education.list': '• Cross College Elite Program, National Cheng Kung University (NCKU)\n• Kaohsiung Industrial High School — Comprehensive Program',
