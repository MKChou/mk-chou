const SITE_I18N = {
  zh: {
    ...
    'home.about.p1': '大家好，我是周明坤（Chou, Ming-Kun），林邊囡仔，略懂音樂、略懂體育，家裡養臘腸狗，目前住在台南，就讀成大不分系，主修電機與資訊工程。比起技術，我更在意為什麼要做；喜歡用設計思考推進計畫，也享受研究探索與發現的過程。',
    ...
    'projects.p1.desc': '2025 創見南方智慧文旅組第一名——不創造不存在的痛點，以設計思考回應真實問題，完成台南ㄏ勝提案。僅簡報，非實際開發。',
    ...
    'about.intro': '我是周明坤，林邊囡仔，略懂音樂，略懂體育，家裡養臘腸狗。目前居住在台南，就讀國立成功大學不分系，主修電機與資訊工程。比起技術本身我更在意為什麼要做，做出真的有意義有價值的事情；喜歡透過設計思考推進計畫，享受做研究探索以及發現的過程，並且不停地迭代去推進事物的邊界。',
  ...
  en: {
    ...
    'home.about.p1': 'Hi, I\'m Chou, Ming-Kun, from Linbian — a little music, a little sports, and a dachshund at home. I live in Tainan and study in the Cross College Elite Program at NCKU, majoring in Electrical Engineering and Computer Science. I care more about why we build something than the tech alone; I like design thinking and enjoy research, exploration, and discovery.',
    ...
    'projects.p1.desc': '1st place at Visioning the South 2025 — responding to real problems through design thinking, not inventing pain points. Tainan Play pitch only; no shipped app.',
